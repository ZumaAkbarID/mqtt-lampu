 ...
 * 
 * translated & modified by : https://github.com/ZumaAkbarID
 * 
...
(function ($) {
    ...
    var str_opt_dow = "";
    var days = ["Minggu", "Senin", "Selasa", "Rabu", "Kamis",
        "Jumat", "Sabtu"];
    ...
    // options for period
    var str_opt_period = "";
    var periods = ["menit", "jam", "hari", "minggu", "bulan", "tahun"];
    ...
    var methods = {
        init: function (opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                + "Setiap <select name='cron-period' class='form-control'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                + " tanggal <select name='cron-dom' class='form-control'>" + str_opt_dom
                + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                + " di <select name='cron-month' class='form-control'>" + str_opt_month
                + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                + " pada menit ke <select name='cron-mins' class='form-control'>" + str_opt_mih
                + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                + " pada <select name='cron-dow' class='form-control'>" + str_opt_dow
                + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                + " jam <select name='cron-time-hour' class='form-control cron-time-hour'>" + str_opt_hid
                + "</select>:<select name='cron-time-min' class='form-control cron-time-min'>" + str_opt_mih
                + " </span>")
                .appendTo(this)
                .data("root", this);
